...
if (!$perintah) {
   ...
   ' - '.$db->error);
    ...
    $query2 = $db->query("INSERT INTO detail_penyetoran (no_faktur,keterangan,dari_akun,ke_akun,jumlah,tanggal,jam,user,jurusan) VALUES ('$no_faktur','$data[keterangan]','$data[dari_akun]','$data[ke_akun]','$data[jumlah]','$data[tanggal]','$data[jam]','$data[user]','$data[jurusan]')");
